...
public class AssetScanner {
    ...
    public static List<String> getPlayerDots(ResourceManager resourceManager) {
        ...
        for (String dotType : dotTypes) {
            Identifier testId = Identifier.of(Constants.MOD_ID,
                    String.format("textures/sprites/hud/player_dots/%s_0.png", dotType));
    ...
    public static List<String> getIconBorderStyles(ResourceManager resourceManager) {
        return checkExistence(resourceManager,
                new String[]{"rounded", "squared"},
                style -> String.format("textures/sprites/hud/player_dots_outlines/%s/default_0.png", style));
    }

    public static List<String> getNameplateBorderStyles(ResourceManager resourceManager) {
        return checkExistence(resourceManager,
                new String[]{"rounded", "squared"},
                style -> String.format("textures/sprites/hud/tags/%s/default.png", style));
    }

    public static List<String> getArrowTypes(ResourceManager resourceManager) {
        return checkExistence(resourceManager,
                new String[]{"default", "mojang"},
                arrow -> String.format("textures/sprites/hud/arrows/%s.png", arrow));
    }

    public static List<String> getDeathMarkerTypes(ResourceManager resourceManager) {
        return checkExistence(resourceManager,
                new String[]{"default", "minimal"},
                marker -> String.format("textures/sprites/hud/death_markers_dots/%s.png", marker));
    }

    private static List<String> checkExistence(ResourceManager resourceManager,
                                               String[] types,
                                               java.util.function.Function<String, String> pathBuilder) {
