...
public class Config {
    ...
    private int globalHudYOffset;
    private String lodestoneMarkerType;
    private int lodestoneMarkerColor;
    private String lodestoneMarkerBorderStyle;
    private String lodestoneMarkerBorderType;
    ...
    public Config() {
        ...
        this.globalHudYOffset = 0;
        this.lodestoneMarkerType = "default";
        this.lodestoneMarkerColor = 0x00FFFF;
        this.lodestoneMarkerBorderStyle = "rounded";
        this.lodestoneMarkerBorderType = "default";
    ...
    private static Config loadConfig() {
        if (CONFIG_FILE.exists()) {
            try (FileReader reader = new FileReader(CONFIG_FILE)) {
                ...
                Logger.error("Config file is corrupted, creating backup and resetting to defaults", e);
                backupAndDelete();
            } catch (Exception e) {
                Logger.error("Unexpected error loading config, resetting to defaults", e);
                backupAndDelete();
            }
        }
    ...
    private static void backupAndDelete() {
        try {
            ...
            if (!CONFIG_FILE.delete()) Logger.warn("Failed to delete corrupted config file");
            Logger.info("Backup saved to: {}", backup.getAbsolutePath());
        } catch (IOException ex) {
            Logger.error("Failed to backup corrupted config", ex);
        }
    }
    ...
    private void validate() {
        ...
        correctedFields.addAll(validateString("lodestoneMarkerBorderStyle", v -> lodestoneMarkerBorderStyle = v, lodestoneMarkerBorderStyle, List.of("rounded", "squared"), "rounded"));
        correctedFields.addAll(validateString("lodestoneMarkerBorderType", v -> lodestoneMarkerBorderType = v, lodestoneMarkerBorderType, List.of("default", "minimal"), "default"));
        ...
        correctedFields.addAll(validateNotEmpty("lodestoneMarkerType", v -> lodestoneMarkerType = v, lodestoneMarkerType));
        ...
        if (!correctedFields.isEmpty())
            Logger.warn("Corrected invalid config fields: {}", String.join(", ", correctedFields));
    }
    ...
    private static void loadPlayers(Config config) {
        ...
        try (FileReader reader = new FileReader(PLAYERS_FILE)) {
            ...
            Logger.error("Error loading players config", e);
        }
    }
    ...
    private void savePlayers() {
        try {
            ...
            if (parent != null && !parent.exists() && !parent.mkdirs()) {
                Logger.error("Failed to create players config directory");
                return;
            }
            ...
            Logger.error("Error saving players config", e);
        }
    }
    ...
    @SuppressWarnings("unused") /* Future implementation */ public void setLodestoneMarkerColor(int value) {set(value, v -> this.lodestoneMarkerColor = v);}
    ...
    public String getLodestoneMarkerType() { return lodestoneMarkerType; }
    public void setLodestoneMarkerType(String value) { set(value, v -> this.lodestoneMarkerType = v); }
    ...
    public String getLodestoneMarkerBorderStyle() {return deathMarkerBorderStyle;}
    ...
    public String getLodestoneMarkerBorderType() { return lodestoneMarkerBorderType; }
    public void setLodestoneMarkerBorderType(String value) { set(value, v -> this.lodestoneMarkerBorderType = v); }
    public boolean isLodestoneMarkerInheritBorderColor() { return lodestoneMarkerInheritBorderColor; }
    public void setLodestoneMarkerInheritBorderColor(boolean value) { set(value, v -> this.lodestoneMarkerInheritBorderColor = v); }
    ...
    public int getGlobalHudYOffset() {return globalHudYOffset;}
    public void setGlobalHudYOffset(int value) { set(MathHelper.clamp(value, -100, 100), v -> this.globalHudYOffset = v); }
    public boolean isEnableIconClustering() { return enableIconClustering; }
